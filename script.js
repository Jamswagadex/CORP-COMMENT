...
const renderFeedbackItem = feedbackItem => {
    ...
    //insert new feedback item in the list
...
const submitHandler = event => {
    ...
    //validate text (check if the text contain #hashtag and long enough )
    ...
    //we have text, extract the other info from text
...
fetch(`${BASE_API_URL}/feedbacks`)
    ...
    const clickHandler2 = event => {
        ...
        // stop funtion if click happened in list, but outside buttons
